const zhCN = {
  ...
  products: {
    ...
    detailTitle: "风格展示", detailSubtitle: "完整图文参考", previewImage: "点击查看大图", colorMaterial: "色彩与材质", stylingReference: "搭配参考", moodReference: "情绪与色彩参考", moodReferenceDesc: "从当下的感受出发选择色彩与材质，只作为穿搭灵感，不替代你的真实感受。",
    shareList: "海米算力 | 珠宝风格参考", shareDetail: "海米算力 | {{name}}"
  },
  data: {
    title: "数据记录", subtitle: "今日记录", score: "今日记录", noRecord: "今天还没有记录。", recorded: "已读取今天保存的真实记录。", calendar: "经期记录", entriesUnit: "条",
    loading: "加载中", loadFailed: "记录加载失败，请检查网络后重试。", retry: "重试", emptyTitle: "暂无今日记录", emptyDesc: "完成今日记录后，这里会显示你保存的状态。", periodLoading: "正在加载经期记录", periodEmpty: "暂无经期记录", periodDueToday: "预计今天来经期", periodDuePassed: "预计经期已到", periodCountdown: "距下次经期还有 {{days}} 天",
  ...
  sleepDetail: {
    ...
    modalTitle: "睡眠记录", modalDate: "日期", modalDuration: "睡眠时长", modalSave: "保存睡眠记录", modalSaved: "保存成功",
    modalInvalidDate: "请选择有效日期", modalInvalidDuration: "请输入有效的睡眠时长", modalLoadFailed: "该日期的睡眠记录读取失败"
  },
  five: {
...
const enUS = {
  ...
  data: {
    ...
    loading: "Loading", loadFailed: "The entry could not be loaded. Check your network and try again.", retry: "Retry", emptyTitle: "No entry today", emptyDesc: "Your saved state will appear here after you complete today's entry.", periodLoading: "Loading cycle records", periodEmpty: "No cycle records yet", periodDueToday: "Expected today", periodDuePassed: "Expected period is due", periodCountdown: "{{days}} days until next period",
  ...
  sleepDetail: {
    ...
    modalTitle: "Sleep record", modalDate: "Date", modalDuration: "Sleep duration", modalSave: "Save sleep record", modalSaved: "Saved",
    modalInvalidDate: "Choose a valid date", modalInvalidDuration: "Enter a valid sleep duration", modalLoadFailed: "Could not load the sleep record for this date"
  },
  five: {
