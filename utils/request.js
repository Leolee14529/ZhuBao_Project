...
function request(options) {
  ...
  return new Promise((resolve, reject) => {
    ...
    console.log("[request:user]", {
      ...
      tokenPrefix: getToken() ? String(getToken()).slice(0, 10) : ""
    });
